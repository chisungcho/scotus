#setwd("C:/Users/michael/Desktop/Scotus_Network_2/scotus/with_node_attributes/shiny_michael6_out_deg")
...
shinyServer(function(input, output) {
  ...
  output$distPlot <- renderPlot({
    ...
    hist(datasetInput(), 
         ...
         xlab = paste("out-degree of ", input$yearA),
         ylim = c(0,100), #For visualization
         main = paste("Histogram of Out-Degrees in ", input$yearA, " of SCOTUS Network"),
         col =  "#39BEB1",
         border =  "#39BEB1"
    )
...
shinyUI(fluidPage(
  ...
  # Application title
  titlePanel("Histogram of Out-Degrees for Each Year of SCOTUS Network"),
