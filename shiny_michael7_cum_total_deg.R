#setwd("C:/Users/michael/Desktop/Scotus_Network_2/scotus/with_node_attributes/shiny_michael7_cum_total_deg")
...
shinyServer(function(input, output) {
  ...
  output$distPlot <- renderPlot({
    ...
    hist(datasetInput(), 
         ...
         xlab = paste("cumulative total-degree up to ", input$yearA),
         ylim = c(0,100), #For visualization purposes set y limit low
         main = paste("Histogram of Cumulative Total-Degrees Up to ", input$yearA, " of SCOTUS Network"),
         col =  "#ACA4E2",
         border =  "#ACA4E2"
    )
...
shinyUI(fluidPage(
  ...
  # Application title
  titlePanel("Histogram of Cumulative Total-Degrees Up to Some Year of SCOTUS Network"),
